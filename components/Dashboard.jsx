...
export default function Dashboard() {
  ...
  const ClientDocumentPreview = ({ type, number, booking, notes = "" }) => {
    ...
    const hasBookingOptions =
      booking?.hireType === "long_term" ||
      Boolean(booking?.comments) ||
      Boolean(booking?.weekendBillingMode) ||
      Boolean(Array.isArray(booking?.selectedWeekendDates) && booking.selectedWeekendDates.length) ||
      Boolean(booking?.includeFuelOnInvoice);
